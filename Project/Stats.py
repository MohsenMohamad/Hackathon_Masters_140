class Data:
    ...
    def top_three_winners(self):  # prints top 3 groups who won highest number of matches.
        ...
        dct.pop(group3)
        print("\u001b[36mHere are top 3 groups winners, who got most winning games!\033[0m")
        print("Group1:\n==")
        ...
        print("Group3:\n==")
        self.print_teams(group1)
        print("\033[1;3;32mCongratulations, you are the best!\033[0m\n")
    ...
    def highest_score(self):  # prints the group who has highest score in a single match.
        ...
        print("\u001b[36mHere is the group who scored the most in one match!\033[0m\n")
        print("Group members:\n==")
